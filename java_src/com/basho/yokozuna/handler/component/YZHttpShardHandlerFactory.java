...
//
// Copied directly from the Apache Lucene/Solr source code and
// modified for the purposes of Yokozuna.
public class YZHttpShardHandlerFactory extends ShardHandlerFactory implements org.apache.solr.util.plugin.PluginInfoInitialized {
  ...
  public void init(PluginInfo info) {
    ...
    final org.apache.http.conn.ClientConnectionManager mgr = this.defaultClient.getConnectionManager();
